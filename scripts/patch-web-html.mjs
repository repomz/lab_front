...
const appleMeta = [
  ...
  '    <style id="lab-system-canvas">html, body { position: fixed; inset: 0; width: 100%; height: 100dvh; min-height: 100svh; margin: 0; padding: 0; overflow: hidden; overscroll-behavior: none; background-color: #17214B; } #root { position: absolute; inset: 0; width: 100%; height: var(--lab-keyboard-height, 100dvh); min-height: 0; overflow: hidden; background-color: #17214B; } html.lab-keyboard [data-testid="bottom-nav"] { display: none !important; } html.lab-keyboard [data-testid="support-page"] { padding-bottom: 0 !important; }</style>',
