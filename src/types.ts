...
export type User = { id: string; email: string; role: Role; full_name: string; specialization?: string; license_number?: string; verified: boolean; patient_profile?: PatientProfile; home_visits?: boolean; appointment_slots?: string[]; avatar_preset?: string; avatar_updated_at?: string };
