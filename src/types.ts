...
export type Analysis = { id: string; owner_id: string; title: string; lab_name?: string; original_name: string; mime_type: string; ocr_text?: string; markers: Marker[]; ai_review: AIReview; status: string; shared_with: string[]; created_at: string };
